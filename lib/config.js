...
config.target = {
  ...
  get name () {return app.storage.read("target-name") || "Wikipedia"},
  get path () {return app.storage.read("target-path") || ".wikipedia.org/wiki/"},
  "TO": {
    ...
    get index () {return parseInt(app.storage.read("target-to-index") || "23")}
  }
};
